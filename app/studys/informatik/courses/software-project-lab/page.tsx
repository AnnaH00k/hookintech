...
const COURSE_TOPICS: CourseTopic[] = [
  {
    ...
    description: "Working in teams to develop a complete software solution for real clients",
    learningObjectives: [
  ...
  },
  {
    ...
    description: "Professional communication and collaboration with project stakeholders",
    learningObjectives: [
