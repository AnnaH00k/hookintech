    ...
    <section className="max-w-3xl w-[95vw] p-4 bg-lighterBackground rounded-lg shadow-lg">
      ...
      <ul className="mt-4 space-y-2">
        {sortedSubjects.map(subject => (
          <li
            key={subject.id}
            className={`flex items-center justify-between p-2 rounded transition-colors duration-300 ${subject.passed ? 'bg-greeny text-background' : ' border-background border text-text'}`}
          >
            <button
            ...
            {settingsSubjectId === subject.id && (
              <div className="flex bg-lighterBackground border border-background p-2 text-center text-text rounded-lg items-center justify-center">
                <label>
                  Note:
                  <input
                    type="number"
                    className="bg-text mx-2 text-background w-12 rounded"
                    value={subject.note || ""}
                ...
                <label>
                  ...
                  <input
                    type="checkbox"
                    className="bg-greeny mx-2 text-text rounded"
                ...
                <label>
                  Exam Type:
                  <select
                    className="bg-text mx-2 text-background rounded"
                    value={newExamType || ""}
                  ...
                  <button
                    className="ml-2 bg-secondary hover:bg-greeny text-text py-1 px-2 rounded"
                ...
                <div className="m-4 gap-1 flex flex-col">
                  <label htmlFor="examDate" className="block text-text text-sm font-bold">
                    Exam Date:
                  </label>
                  <input
                    type="date"
                    id="examDate"
                    name="examDate"
                    className="shadow appearance-none bg-text rounded w-full py-1 px-2 text-background leading-tight focus:outline-none focus:shadow-outline"
            ...
            <button
              className={` hover:scale-[120%] font-bold py-1 px-2 rounded ${subject.passed ? ' text-background' : 'text-text'}`}
