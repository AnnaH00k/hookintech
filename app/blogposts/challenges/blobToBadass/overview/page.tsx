...
export default function Home() {
  ...
  const dailyTasks = [
    ...
    { date: "42", privateProjects: "", study: " 3h IOT research reading articles", work: "4h working for Clye", health: "2h figure skating & 2h bike ride", topicOfTheWeek: "IOT", question: "What is QoL?", answer:"QoL stands for \"Quality of Life.\" It refers to the overall well-being and happiness of a person or group, considering factors like health, comfort, safety, and life satisfaction. It measures how good or satisfying life is for someone, beyond just wealth or material things." },
